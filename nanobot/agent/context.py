...
When remembering something, use {workspace_path}/memory/LTM_SNAPSHOT.json for runtime memory and {workspace_path}/memory/MEMORY.md for human-readable notes."""
